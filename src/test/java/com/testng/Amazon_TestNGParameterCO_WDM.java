...
public class Amazon_TestNGParameterCO_WDM {
	public static WebDriver driver;
	String searchIn;t
	static String dropInput;
	@BeforeSuite
	public static void setUp() {
		List<String> chromeOptList = new ArrayList<>();
		chromeOptList.add("start-maximized");
		chromeOptList.add("incognito");
		chromeOptList.add("disable-popup-blocking");
//		chromeOptList.add("headless");
//		System.setProperty("webdriver.chrome.driver",
//				"C:\\Users\\WELCOME\\eclipse-workspace\\IPT_Project_Amazon\\Driver\\chromedriver.exe");
		ChromeOptions opt = new ChromeOptions();
		opt.addArguments(chromeOptList);
